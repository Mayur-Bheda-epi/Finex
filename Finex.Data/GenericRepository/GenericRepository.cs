...
namespace Finex.Data.GenericRepository
{
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        public GenericRepository(FinexAlmondzEntities context)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IEnumerable<TEntity> GetPaged(Func<TEntity, bool> where, int pageSize,int pageNumber)
        {
            IQueryable<TEntity> query = DbSet;
            return query.Where(where).Skip(pageSize * (pageNumber - 1)).Take(pageSize).ToList();
        }
        ...
        /// <summary>
        /// generic method to get count record on the basis of a condition.
        /// </summary>
        /// <param name="where"></param>
        /// <returns></returns>
